        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <div className="max-w-2xl mx-auto px-6 py-10">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-3xl font-bold text-slate-900">My Paper Tests</h2>
                    <Link
                        to="/paper-upload"
                ...
                {tests.length === 0 && !error && (
                    <p className="text-slate-500">You haven't uploaded any paper tests yet.</p>
                )}
                    ...
                    {tests.map((test) => {
                        ...
                        return (
                            <Link
                                ...
                                className="block bg-white border border-slate-200 rounded-xl p-5 shadow-sm hover:shadow-md transition"
                            >
                                <div className="flex justify-between items-start">
                                    <div>
                                        ...
                                        {attempted ? (
                                            ...
                                            <p className="text-xs text-indigo-600 mt-3">Not attempted yet — click to start</p>
                                        )}
                                    </div>
