...
function Register() {
    ...
    <div className="absolute -top-20 -right-20 w-72 h-72 bg-purple-200 dark:bg-orange-900/20 rounded-full blur-3xl opacity-50"></div>
    <div className="absolute -bottom-20 -left-20 w-72 h-72 bg-indigo-200 dark:bg-orange-900/30 rounded-full blur-3xl opacity-50"></div>
    ...
    <div className="relative bg-white dark:bg-zinc-950 shadow-xl rounded-3xl p-8 w-full max-w-md border border-slate-100 dark:border-orange-500/20">
        ...
        <p className="text-slate-500 dark:text-zinc-400 mb-6">Start learning with AI-powered tools</p>
        ...
        <p className="text-sm text-slate-500 dark:text-zinc-400 mt-6 text-center">
            ...
            <Link to="/login" className="text-indigo-600 dark:text-orange-500 font-medium hover:underline">
                Log In
            </Link>
        </p>
    </div>
