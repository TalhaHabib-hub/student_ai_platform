...
function Register() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4 relative overflow-hidden">
            <div className="absolute -top-20 -right-20 w-72 h-72 bg-purple-200 rounded-full blur-3xl opacity-50"></div>
            <div className="absolute -bottom-20 -left-20 w-72 h-72 bg-indigo-200 rounded-full blur-3xl opacity-50"></div>
            ...
            <div className="relative bg-white shadow-xl rounded-3xl p-8 w-full max-w-md border border-slate-100">
                ...
                <p className="text-slate-500 mb-6">Start learning with AI-powered tools</p>
