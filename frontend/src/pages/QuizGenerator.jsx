    ...
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            <div className="max-w-2xl mx-auto px-6 py-10">
                <h2 className="text-3xl font-bold text-slate-900 mb-1">Generate a Quiz</h2>
                <p className="text-slate-500 mb-6">Paste notes, or upload photos, PDFs, or text files — you can add several.</p>

                <form onSubmit={handleGenerate} className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
                    <textarea
                        value={notes}
                        onChange={(e) => setNotes(e.target.value)}
                        placeholder="Paste your study notes here..."
                        rows={6}
                        className="w-full bg-slate-50 border border-slate-200 text-slate-900 placeholder-slate-400 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-400 resize-none"
                    />

                    <div className="text-center text-slate-400 text-sm my-3">— and/or —</div>
                ...
                {quiz && (
                    <div className="mt-8 space-y-4">
                        <h3 className="text-lg font-semibold text-slate-900">Your Quiz</h3>
                        ...
                        {submitted && (
                            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm flex gap-6">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-green-600">{quiz.correct_count}</p>
                                </div>
                                <div>
                                    <p className="text-slate-500 text-sm">Wrong</p>
                                    <p className="text-2xl font-bold text-red-600">{quiz.wrong_count}</p>
                                </div>
                            </div>
                        )}
                        ...
                        {!submitted && (
                            <button
                                ...
                                disabled={submitting}
                                className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white font-semibold rounded-xl py-3 transition"
                            >
